...
CREATE DATABASE IF NOT EXISTS `freedb_mechaniclagbe`
/*!40100 DEFAULT CHARACTER SET utf8 */
;

USE `freedb_mechaniclagbe`;
...
INSERT
  IGNORE INTO `mechanic` (`mechanic_id`, `mechanic_name`, `order_count`)
VALUES
